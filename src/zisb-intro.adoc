...
When Zisb is implemented, the predictions learned in one domain cannot be used
to predict outcomes in another domain. The Zisb extension additionally provides
mechanisms to control speculation leading to in-domain and cross-domain attacks
through the use of speculation barrier instructions to explicitly control
speculation boundaries and ensure that transient execution--arising from control
flow, data value, or dependency speculation--does not expose data through side
channels.
